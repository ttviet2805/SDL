...
const string studentScoreFileName = "Data/CSVFileExport/StudentScore/";
const string staffFileName = "Data/AllStaff.txt";
const string studentInClassFileName = "Data/CSVFileExport/Class/";
const string studentCSVFileName = "Data/CSVFileImport/Student/StudentCSV.csv";
const string exportClassFilename = "Data/CSVFileExport/Class/";
const string exportSchoolYearFilename = "Data/CSVFileExport/SchoolYear/";
const string exportCourseScoreFilename = "Data/CSVFileExport/CourseScore/";
