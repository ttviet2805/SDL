...
const string studentScoreFileName = "Data/CSVFile/StudentScore/";
const string staffFileName = "Data/AllStaff.txt";
const string studentInClassFileName = "Data/CSVFile/Class/";
const string studentCSVFileName = "Data/CSVFile/Student/StudentCSV.csv";
const string exportClassFilename = "Data/CSVFile/Class/";
const string exportSchoolYearFilename = "Data/CSVFile/SchoolYear/";
